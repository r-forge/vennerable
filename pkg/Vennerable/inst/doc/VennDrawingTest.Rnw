...
\usepackage{Sweave}
\SweaveOpts{prefix.string=figdir/VDT,cache=TRUE,debug=TRUE,eps=FALSE,echo=FALSE,pdf.version=1.4}
\usepackage{natbib}
\usepackage{mathptmx}
\usepackage{rotating} 
\usepackage{float} 
...
<<C2show,fig=TRUE,echo=FALSE>>=
 ...
 grid.segments(x0=C2@centres[1,1],x1=C2@centres[1,1]+d1,y0=0,y1=0,default.units="native")
 grid.segments(x0=C2@centres[2,1],x1=C2@centres[2,1]-d2,y0=0,y1=0,default.units="native")
 grid.segments(x0=C2@centres[1,1]+d1,x1=C2@centres[1,1]+d1,y0=0,y1=y,default.units="native")
 grid.segments(x0=C2@centres[1,1],x1=C2@centres[1,1]+d1,y0=0,y1=y,default.units="native")
 grid.segments(x0=C2@centres[2,1],x1=C2@centres[2,1]-d2,y0=0,y1=y,default.units="native")
...
grid.newpage()
PlotVennGeometry(T3,show=list(FaceText="",indicator.string=TRUE))
@
...
grid.newpage()
PlotVennGeometry(T3a,show=list(indicator.string=TRUE))
@
\end{center}
\end{figure}
...
grid.newpage()
PlotVennGeometry(S3a,show=list(indicator.string=TRUE,FaceText=""))
downViewport("Vennvp")
PlotNodes(S3a)
checkAreas(S3a)
@
...
sho4 <- function(CR4) {
	grid.newpage()
	PlotVennGeometry(CR4 ,show=list(indicator.string=TRUE,FaceText=""))
	downViewport("Vennvp")
	plot.grideqsc(-4:4)
...
CR3a <- compute.CR(V3a)
grid.newpage()
PlotVennGeometry(CR3a ,show=list(indicator.string=TRUE,FaceText=""))
downViewport("Vennvp")
#PlotNodes(T3a )
checkAreas(CR3a )
@
...
CR4a <-  compute.CR(V4a)
grid.newpage()
PlotVennGeometry(CR4a ,show=list(indicator.string=TRUE,FaceText=""))
downViewport("Vennvp")
#PlotNodes(CR4a )
checkAreas(CR4a )
...
#PlotVennGeometry(CR4w ,show=list(indicator.string=TRUE,FaceText=""))
#downViewport("Vennvp")
#PlotNodes(CR4a )
@
\caption{Chow-Ruskey weighted 4-set diagram}
...
CK4f <- compute.CR(V4f)
grid.newpage()
PlotVennGeometry(CK4f,show=list(FaceText="weight",SetLabels=FALSE))
@
\end{center}\end{figure}
